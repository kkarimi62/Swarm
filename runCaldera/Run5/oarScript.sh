...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/runCaldera/Run5/swarmCaldera.ipynb ./output.ipynb -p Df 2.0 -p quantile 0.05 -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/LongValleyCaldera/catalog1st.csv'
