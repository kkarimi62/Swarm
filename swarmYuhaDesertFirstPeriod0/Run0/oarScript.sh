...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/swarmYuhaDesertFirstPeriod0/Run0/swarmYuhaDesertFirstPeriod.ipynb ./output.ipynb  -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/YuhaDesert/EMC.csv'
