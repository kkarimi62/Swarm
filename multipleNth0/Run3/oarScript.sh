...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/multipleNth0/Run3/DifferentThresholds.ipynb ./output.ipynb -p	bval	1e-05 -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/Oklahoma/TableS1.csv'
