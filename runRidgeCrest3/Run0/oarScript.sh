...
papermill --prepare-only /newhome/kamran.karimi1/Project/git/Swarm/runRidgeCrest3/Run0/RidgeCrest2019_recovered.ipynb ./output.ipynb -p	quantile	0.45 -p SWARM_PATH '/newhome/kamran.karimi1/Project/git/Swarm/dataset/RidgeCrest/DataS1_noXYZ.txt'
