...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/multipleNth4/Run1/DifferentThresholds.ipynb ./output.ipynb -p	bval	0.1 -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/Oklahoma/TableS1.csv'
