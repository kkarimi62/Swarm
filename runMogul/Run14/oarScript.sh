...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/runMogul/Run14/Mogul2008.ipynb ./output.ipynb -p quantile 0.05 -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/Mogul2008/catsearch.14436'
