...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/multipleNth1/Run2/DifferentThresholds.ipynb ./output.ipynb -p	n_thresh	0.0001 -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/Oklahoma/TableS1.csv'
