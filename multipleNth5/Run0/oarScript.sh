...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/multipleNth5/Run0/DifferentThresholds.ipynb ./output.ipynb -p	bval	1.0 -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/Oklahoma/TableS1.csv'
