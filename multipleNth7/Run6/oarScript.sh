...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/multipleNth7/Run6/DifferentThresholds.ipynb ./output.ipynb -p	bval	100.0 -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/Oklahoma/TableS1.csv'
