...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/multipleNth0/Run2/DifferentThresholds.ipynb ./output.ipynb -p	n_thresh	1e-05 -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/Oklahoma/TableS1.csv'
