...
jupyter nbconvert --execute /home/kamran.karimi1/Project/git/Swarm/runMogul20/Run0/output.ipynb --ExecutePreprocessor.timeout=-1 --ExecutePreprocessor.allow_errors=True;rm ./output.html
