...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/multipleNth6/Run1/DifferentThresholds.ipynb ./output.ipynb -p	bval	10.0 -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/Oklahoma/TableS1.csv'
