...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/multipleNth4/Run0/DifferentThresholds.ipynb ./output.ipynb -p	n_thresh	0.1 -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/Oklahoma/TableS1.csv'
