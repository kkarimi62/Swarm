...
jupyter nbconvert --execute /home/kamran.karimi1/Project/git/Swarm/runOklahoma/Run1/output.ipynb --ExecutePreprocessor.timeout=-1 --ExecutePreprocessor.allow_errors=True;ls output.html
