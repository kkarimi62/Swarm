...
papermill --prepare-only /newhome/kamran.karimi1/Project/git/Swarm/runRidgeCrest1/Run0/RidgeCrest2019_recovered.ipynb ./output.ipynb -p	quantile	0.18333333333333335 -p SWARM_PATH '/newhome/kamran.karimi1/Project/git/Swarm/dataset/RidgeCrest/DataS1_noXYZ.txt'
