...
jupyter nbconvert --execute /home/kamran.karimi1/Project/git/Swarm/runMogul/Run8/output.ipynb --ExecutePreprocessor.timeout=-1 --ExecutePreprocessor.allow_errors=True
