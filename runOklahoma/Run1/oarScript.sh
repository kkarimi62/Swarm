...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/runOklahoma/Run1/swarmOklahoma.ipynb ./output.ipynb -p Df 2.0 -p quantile 0.05 -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/Oklahoma/TableS1.csv'
