...
papermill --prepare-only /home/kamran.karimi1/Project/git/Swarm/multipleNth3/Run6/DifferentThresholds.ipynb ./output.ipynb -p	bval	0.01 -p SWARM_PATH '/home/kamran.karimi1/Project/git/Swarm/dataset/Oklahoma/TableS1.csv'
